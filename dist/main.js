...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _appender__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appender */ \"./src/appender.js\");\n/* harmony import */ var _category__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./category */ \"./src/category.js\");\n/* harmony import */ var _stock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stock */ \"./src/stock.js\");\n/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utility */ \"./src/utility.js\");\n/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./events */ \"./src/events.js\");\n// default page \n\n\n\n\n\n\nconst default_page = ()=>{\n\n    const sideba = sidebar();\n\n    const div_principal = mainSection();\n    \n    \n    \n    \n\n    document.querySelector(\"body\").appendChild(sideba);\n    document.querySelector(\"body\").appendChild(div_principal);\n    \n}\n\n\n\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (default_page);\n\nconst createInput = (name,id,div_id)=>{ // modifie or conflits\n    const div = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",div_id);\n    const input = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"input\",id);\n    const label = document.createElement(\"label\");\n    label.setAttribute(\"for\",id); \n    label.textContent = name;\n    appendFct(div,label,input);\n    return div;\n\n}\n\nconst appendFct=(arg1,...arg2)=>{\n    for(let i=0;i<arg2.length;i++){\n        arg1.appendChild(arg2[i]);\n    }\n    \n}\n\nfunction sidebar(){\n    const sidebar = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"sidebar\");\n    const div_title = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"title\");\n    const div_container_input = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"input-title-container\");\n    const div_input = createInput(\"Title: \",\"input-title\",\"div-input-title\");//ca a modifier or conflits \n    const title = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"h2\",\"title-category\",\"Categories\");\n    const div_categories = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"categories_container\")\n    const button = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"button\",\"create-new-category\",\"Create\");\n\n    //la grosse parentese...\n    button.addEventListener(\"click\",()=>{\n        const title = prompt(\"Title : \");\n        const categ = (0,_category__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(title,_stock__WEBPACK_IMPORTED_MODULE_2__[\"default\"].length);//la peut-etre il va falloir créer un html element \n        _stock__WEBPACK_IMPORTED_MODULE_2__[\"default\"].push(categ);\n        _appender__WEBPACK_IMPORTED_MODULE_0__[\"default\"].appendCategory(categ);\n    })\n    //fermeture de la grosse parenthese\n    appendFct(div_title,title);\n    appendFct(div_container_input,div_input,button);\n    appendFct(sidebar,div_container_input,div_title,div_categories);\n\n    return sidebar;\n}\n\nfunction mainSection(){\n    const div_principal = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"principal\");\n\n    const main_inputs = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"main-inputs\");\n    const title_todo = createInput(\"Title: \",\"title-todo\",\"div-title-todo\");\n    const desc_todo = createInput(\"Description: \",\"desc-todo\",\"div-desc-todo\");\n    const button = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"button\",\"create-new-item\",\"ADD\");\n    button.addEventListener(\"click\",_events__WEBPACK_IMPORTED_MODULE_4__[\"default\"].add_item.bind(null,button));\n    const main = _utility__WEBPACK_IMPORTED_MODULE_3__[\"default\"].createElmt(\"div\",\"main\");\n\n    appendFct(main_inputs,title_todo,desc_todo,button);\n    appendFct(div_principal,main_inputs,main);\n\n    return div_principal;\n}\n\n//# sourceURL=webpack://todolist/./src/default-page.js?");
